      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 h-[70px] lg:h-[80px] flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button 
              className="px-6 py-2.5 bg-[#D4AF37] hover:bg-[#C49F27] text-white font-bold text-sm rounded-full shadow-lg shadow-[#D4AF37]/20 transition-all duration-300 hover:-translate-y-0.5"
            >
          ...
          <div className="px-6 py-5 space-y-1">
            ...
            <div className="pt-4 mt-4 border-t border-[#E5E7EB] space-y-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full py-3 border-2 border-[#0A2540]/20 text-[#0A2540] font-semibold rounded-full"
              >
                WhatsApp
              </a>
